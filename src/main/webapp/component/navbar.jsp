...
<nav class="navbar navbar-expand-lg navbar-dark bg-primary">
	<div class="container-fluid">
		<a class="navbar-brand me-5 pe-5" href="index.jsp"><i
		...
		<div style="margin-left:325px" "class="mx-auto justify-content-center"><a class="navbar-brand" href="index.jsp"><i
			></i>PACE PEDIATRIC CENTER</a></div>
